...
export class AddPatientComponent implements OnInit{
  ...
  constructor( private fb : FormBuilder,
    ...
    private dataApi : DataService
      ...
      this.title = data.title;
        ...
        this.addmission_date = data.addmission_date;
  ...
  ngOnInit(): void {
    ...
    this.form = this.fb.group({
      ...
      addmission_date : [this.addmission_date,[Validators.required]],
  ...
  async registerPatient(){
          this.form.value.getDoctorName = await this.getDoctorName(this.form.value.id);
